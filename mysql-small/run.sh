...
chmod 777 /root/data/mysql

docker run --name mysql   -p 9992:22 -p 3307:3306 -d  -v /etc/localtime:/etc/localtime:ro   -v /root/data/mysql:/var/lib/mysql jdocker/mysql-small:v1
